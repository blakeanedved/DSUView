  ...
  >
    ...
    >
      ...
      <div class="min-w-0 flex-auto space-y-0.5">
        <p
          class="text-blue-600 dark:text-blue-400 text-sm sm:text-base lg:text-sm xl:text-base font-semibold uppercase"
        >
    ...
    <div class="space-y-2">
      <div class="bg-gray-200 dark:bg-black rounded-full overflow-hidden">
        <div
          class="temp-progressbar-class bg-blue-500 dark:bg-lime-400 w-1/2 h-1.5"
          role="progressbar"
          aria-valuenow="1456"
          aria-valuemin="0"
          aria-valuemax="4550"
